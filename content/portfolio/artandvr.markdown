...
categories: 
 - installation
image: /img/artandvr/thumbnail.jpg
---
...
<iframe src="https://player.vimeo.com/video/206780970" style="width:100%; height:400px" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 

## 3D fractal visualizer app
I realized if I turn down the resolution of the vive to like 60%, you can raymarch some pretty sweet fractals at 90fps. I want to develop this more to reconstruct images at full resolution like my [iOS visualizer]({{ site.baseurl }}{% link _posts/2016-07-10-iOS_mandelbox.markdown %}). But first I created a 3D control system to explore the 3D space. Vive controllers are awesome.
...
This allows the user to manipulate Rotation, Translation and Scale. 
